...
# Yoti values
YOTI_AUTH = os.environ['YOTI_AUTH']
YOTI_CLIENT_SDK_ID = os.environ['YOTI_CLIENT_SDK_ID']
YOTI_KEY_FILE_PATH = os.environ['YOTI_KEY_FILE_PATH']
YOTI_APPLICATION_ID = os.environ['YOTI_APPLICATION_ID']
YOTI_CLIENT_SDK_ID = os.environ['YOTI_CLIENT_SDK_ID']
YOTI_LOGIN_SCENARIO_ID = os.environ['YOTI_LOGIN_SCENARIO_ID']
YOTI_REGISTER_SCENARIO_ID = os.environ['YOTI_REGISTER_SCENARIO_ID']
YOTI_SIGN_SCENARIO_ID = os.environ['YOTI_SIGN_SCENARIO_ID']

# Payment settler X.500 values
