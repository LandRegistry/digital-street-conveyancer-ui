...
from conveyancer_ui.custom_extensions.gzip_static_assets.main import gzip_cache
from conveyancer_ui.custom_extensions.gzip_static_assets.main import gzip_cache_key
...
class TestGzipStaticAssets(unittest.TestCase):
    ...
    @mock.patch('conveyancer_ui.custom_extensions.gzip_static_assets.main.GzipStaticAssets.init_app')
    ...
    def test_gzipped_response(self):
        # Create test file
        filename = 'conveyancer_ui/assets/dist/gzip-test.css'
